...
class ResCompany(models.Model):
    ...
    sale_restrict_consumable = fields.Boolean("Restrict Consumable (Sales)", default=False)
    ...
    invoice_restrict_consumable = fields.Boolean("Restrict Consumable (Invoices)", default=False)
...
class ResConfigSettings(models.TransientModel):
    ...
    strict_stock_validation = fields.Boolean(related='company_id.strict_stock_validation', readonly=False, string="Strict Stock Validation (Ordered & Delivered)")
